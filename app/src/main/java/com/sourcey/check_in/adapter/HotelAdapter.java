...
import com.sourcey.check_in.DetailHotelActivity;
...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder> {
 ...
 //   NumberFormat formatRupiah = NumberFormat.getCurrencyInstance(localeID);
    ...
    public void onBindViewHolder(final ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.tv_nama_hotel.setText(hotel.getNama_hotel());
      ...
      //  holder.tv_harga_per_malam.setText(formatRupiah.format((double)hotel.getHarga_per_malam()));
        ...
        holder.cv_hotel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("nama_hotel",hotelList.get(position).getNama_hotel());
              ...
              //  intent.putExtra("harga_per_malam",hotelList.get(position).getHarga_per_malam());
                ...
                intent.putExtra("kelengkapan",hotelList.get(position).getKelengkapan());
             ...
             //   intent.putExtra("refundable",hotelList.get(position).getRefundable());
                ...
                Toast.makeText(mContext, "Ke List Hotel " + hotelList.get(position).getNama_hotel(), Toast.LENGTH_SHORT).show();
//                Toast.makeText(mContext, "Rate " +hotelList.get(position).getHarga_per_malam(), Toast.LENGTH_SHORT).show();
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_nama_hotel, tv_rating, tv_alamat;
        CardView cv_hotel;
        RatingBar ratingBar;
        ImageView foto;
