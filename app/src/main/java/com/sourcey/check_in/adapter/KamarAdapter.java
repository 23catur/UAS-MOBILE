package com.sourcey.check_in.adapter;
...
import com.sourcey.check_in.PesanActivity;
...
//    String tujuan = intent.getStringExtra("tujuan");
    ...
    @Override
    public void onBindViewHolder(final KamarAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.tv_nama_kamar.setText(kamar.getNama_ruangan());
        holder.tv_max_orang.setText("Maks. " +kamar.getMax_orang() + " orang");
        holder.tv_ukuran.setText(kamar.getUkuran_ruangan() + " m");
        holder.tv_terpesan.setVisibility(View.GONE);
        if (kamar.getKelengkapan().equals("yes")){
        ...
        holder.tv_tipe_kasur.setText("Tipe kasur : " +kamar.getTipe_ruangan());
        ...
        holder.btn_pesan_kamar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("nama_kamar", kamarList.get(position).getNama_ruangan());
                intent.putExtra("tipe_kasur", kamarList.get(position).getTipe_ruangan());
                intent.putExtra("max_orang", kamarList.get(position).getMax_orang());
                intent.putExtra("ukuran_kamar", kamarList.get(position).getUkuran_ruangan());
                intent.putExtra("sarapan", kamarList.get(position).getKelengkapan());
