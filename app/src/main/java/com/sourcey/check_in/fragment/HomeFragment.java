...
import com.sourcey.check_in.ListHotelActivity;
...
public class HomeFragment extends Fragment {
   ...
   //     tot_malam = (TextView) view.findViewById(R.id.tot_malam);
        ...
        btn_cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (set_tamu<set_kamar) {
                    Snackbar.make(v, "Jumlah ruangan tidak bisa melebihi jumlah mahasiswa", Snackbar.LENGTH_LONG).show();
                    Toast.makeText(getContext(),"Jumlah ruangan tidak bisa melebihi jumlah mahasiswa",Toast.LENGTH_SHORT).show();
                }else {
    ...
    private void openDateRangePicker(){
        ...
        pickerFrag.show(Objects.requireNonNull(getActivity()).getSupportFragmentManager(), "SUBLIME_PICKER");
    }
